...
If you have any questions or encounter roadblocks in completing the steps during the course of the pilot, please do not hesitate to reach out to info@publicdomainmap.org
...
If you do not receive the welcome message as shown above or if you would like to revisit the walkthrough in the future, you can always access the walkthrough in the iD Editor. Once in the iD Editor, select the "Help" option in the right-hand menu. In the Help menu, you can select "Start the Walkthrough".
...
[Further sections to be drafted]
...
*Please note: there may be several days between completion of this form and reciept of further instructions.*

```
Add any internal notes about the feedback form here:

- Add acknowledgement of participation & that data will go into the public domain, and data during pilot may not be contributed to OSM.
...
Text and images developed by Jess Beutler (OSM US) for the [HOTOSM Toolbox](https://toolbox.hotosm.org/pages/credits/credits-overview/) have been adapted for this guide. 
